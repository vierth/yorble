...
def remove_common(quoteinfo, threshold,filtersimilar,simthresh, shortquotelength):
...
def run(filtercommon, shortquotelength, repmax, filtersimilar, similaritythreshold, limitcheck,limextent, quoteresultscorpus,outputfile):
    ...
    if filtercommon:
        results = remove_common(results, repmax,filtersimilar,similaritythreshold, shortquotelength)
